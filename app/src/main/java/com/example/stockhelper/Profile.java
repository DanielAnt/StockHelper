...
public class Profile extends AppCompatActivity implements View.OnClickListener {
                ...
                if(snapshot.child("Users").child(mAuth.getCurrentUser().getUid()).hasChild("game")) {
                    ...
                    if(snapshot.child("Users").child(mAuth.getCurrentUser().getUid()).child("game").hasChild("purchasedStocks")) {
                        ...
                        for (int i = 0; i < tempActions.size(); i ++) {
                            ...
                            //itemsPrices.add(tempActions.get(i + 1));
                        ...
                        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                ...
                                jsonParse(stockSymbol,Float.parseFloat(stockQuantity),Float.parseFloat(accBText.getText().toString()),arrayAdapter, total,i);
    ...
    private void jsonParse(String stockSymbol, Float stockQunatity, Float currentMoney, ArrayAdapter arrayAdapter, ArrayList total, int i ) {
